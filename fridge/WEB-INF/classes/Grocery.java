...
public class Grocery {
	...
	//this could probably not be used as id is assigned by the database on creation but i simply put a min value
	@Min(value = 0)
	private int id;
	
	
	//TODO 02: add which annotation? Does it have any params?
	// annotations are in the item class. min and max length for name
	@NotNull
	private Item item;

	
	//TODO 03: add which annotation? Does it have any params?
	//@NotNull not required as date is added when inserted to database
	private LocalDate date;
	
	
	//TODO 04: add which annotation? Does it have any params?
	// set min max, could make max higher for a larger fridge
